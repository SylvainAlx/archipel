        ...
        <>
          ...
          <section className="w-[80%] flex flex-col items-center gap-2 text-justify">
            ...
            <p>
              ...
              . Ce dernier développe et maintient seul le site et le rend
              disponible aux internautes à titre gratuit.
            </p>
            <H2 text="Hébergement" />
            <p>
            ...
            <p>
              ...
              iconographiques et photographiques. Le contenu du site est, sauf
            ...
            <p>
              ...
              utilisateurs et ne collecte et ne conserve aucune donnée
              personnelle, à savoir aucun cookie, aucune adresse IP, aucun nom
              et aucune adresse postale ou mail.
            </p>
          </section>
        </>
      ) : (
        <>
          <H1 text="Legal notice" />
