...
export default function NationComs({ text }: StringProps) {
  ...
  return (
    <>
      ...
      <section className="w-[80%] min-w-[300px] flex flex-col-reverse justify-center gap-1 items-center text-sm">
        {comsList != undefined &&
          comsList.map((com, i) => {
            return (
              <div
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  {com.comType === 0 && (
                    <span className="w-2/5">Déclaration officielle</span>
                  )}
                  {com.comType === 1 && (
                    <span className="w-2/5">Nouvelle nation</span>
                  )}
                  {com.comType === 2 && (
                    <span className="w-2/5">Suppression de la nation</span>
                  )}
                  <span className="w-2/5 text-right text-md">
                    {com.originName}
                  </span>
                </div>
                {com.title && (
