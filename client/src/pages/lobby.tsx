...
export default function Lobby(){
    ...
    return (
        <main className="flex flex-col items-center justify-center gap-4 h-[70vh]">
            ...
            <H1 text={TITLE} />
            <p className="max-w-[80%] text-center">Renseignez le mot de passe pour accéder à l'application</p>
            <form className="flex flex-col items-center justify-center gap-2" onSubmit={handleSubmit}>
                <Input type="password" placeholder="Mot de passe" name="password" required value={password} onChange={handleChange} />
