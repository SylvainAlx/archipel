...
export default function PublicNationTile({ name, data }: Nation) {
  ...
  return (
    <div className="relative bg-complementary flex flex-col items-center p-2 gap-4 rounded">
      <div className="absolute top-[-10px] left-[-10px] w-[50px] h-[50px] bg-complementary rounded-full flex items-center justify-center">
        {data.url.flagUrl != "" ? (
          <img
